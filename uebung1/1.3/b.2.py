...
ax.set_ylabel('y')
ax.set_zlabel('t')
title('Comparition of 2dimensional DGL1 with x0 = 1, y0 = 1')
ax.plot(x_ei, y_ei, t, color = 'blue', linestyle = '-', label = 'Euler explicite intergration')
ax.plot(x_anloe, y_anloe, t, color = 'red', linestyle = '-', label = 'Analytic Solve')
