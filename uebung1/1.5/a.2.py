...
print 'Euler explicit and implicit integration of y\'=-ky with A-stability test'
k = float(raw_input('Please input k:'))

eei = Euler_Expl_Intg(x_start = 0, x_end = 10, p_num = 404, k = -k)
eei.gen_y(y0_start = 1, y0_end = 1, y0_step = 1)
...
title('eular implizite integration which is%s A-stable' % 
	  negation)
